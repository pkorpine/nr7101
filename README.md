...
```json
{'cellular': {'CELL_Roaming_Enable': False,
              'INTF_BSIC': 0,
              'INTF_CQI': 11,
 ...
 'traffic': {'br0': {'BroadcastPacketsReceived': 0,
                     'BroadcastPacketsSent': 0,
                     'BytesReceived': 1151098625,
                     'BytesSent': 2625211743,
                     ...
                     'PacketsReceived': 6783332,
                     'PacketsSent': 5672222,
                     'UnicastPacketsReceived': 0,
                     'UnicastPacketsSent': 0,
                     'UnknownProtoPacketsReceived': 0},
             'wwan0': {'BroadcastPacketsReceived': 0,
                       'BroadcastPacketsSent': 0,
                       'BytesReceived': 2940569599,
                       'BytesSent': 1699008693,
                       'DiscardPacketsReceived': 0,
                       'DiscardPacketsSent': 0,
                       'ErrorsReceived': 0,
                       'ErrorsSent': 141,
                       'MulticastPacketsReceived': 0,
                       'MulticastPacketsSent': 0,
                       'PacketsReceived': 107094790,
                       'PacketsSent': 73933824,
                       'UnicastPacketsReceived': 0,
                       'UnicastPacketsSent': 0,
                       'UnknownProtoPacketsReceived': 0},
             'wwan1': {'BroadcastPacketsReceived': 0,
                       'BroadcastPacketsSent': 0,
                       'BytesReceived': 0,
                       'BytesSent': 0,
                       'DiscardPacketsReceived': 0,
